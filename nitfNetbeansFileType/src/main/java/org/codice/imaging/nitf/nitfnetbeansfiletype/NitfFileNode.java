...
public class NitfFileNode extends DataNode {
    ...
    protected Sheet createSheet() {
        ...
        set.put(new DateProperty("fileDateTime", "File Date and Time", "Date and time of this file's orgination.", nitf.getFileDateTime().toDate()));
        ...
        set.put(new StringProperty("securityClassificationSystem",
                                   ...
                                   "The national or multinational security system used to classify the file content. 'XN' indicates NATO security system marking guidance.",
