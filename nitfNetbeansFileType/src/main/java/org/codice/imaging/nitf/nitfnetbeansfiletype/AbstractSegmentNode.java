...
abstract class AbstractSegmentNode extends AbstractNode {
    ...
    public AbstractSegmentNode(Children children) {
        super(children);
    }

    protected void addSubSegmentProperties(Sheet.Set set, AbstractNitfSubSegment segment) {
        ...
        set.put(new StringProperty("securityClassificationSystem",
                                   ...
                                   "The national or multinational security system used to classify the segment content. 'XN' indicates NATO security system marking guidance.",
        ...
        set.put(new IntegerProperty("attachmentLevel", "Attachment Level", "The attachment level for this segment.", segment.getAttachmentLevel()));
    }
