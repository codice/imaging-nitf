...
class SymbolSegmentViewAction extends AbstractAction {

    private final NitfSymbolSegmentNode associatedNode;

    public SymbolSegmentViewAction(final NitfSymbolSegmentNode node) {
        putValue(NAME, "View");
        associatedNode = node;
    }
