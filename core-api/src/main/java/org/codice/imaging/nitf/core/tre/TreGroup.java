...
public interface TreGroup {
     ...
     * @param tagName the name (tag) of the field to look up.
     * @return the entry corresponding to the tag name.
     * @throws NitfFormatException when the tag is not found or is not a simple
     * field
     */
    TreSimpleEntry getSimpleEntry(String tagName) throws NitfFormatException;

    /**
     * Get the group list entry for a specific tag.
     *
     * @param tagName the name (tag) of the group list entry to look up.
     * @return the entry corresponding to the tag name.
     * @throws NitfFormatException when the tag is not found or is not a group
     * list
     */
    TreGroupListEntry getGroupListEntry(String tagName) throws NitfFormatException;
     ...
     * be converted to integer format.
     */
