...
public class ImageSegmentFactoryTest {
    ...
    public void checkAdditionalDataBuild() throws NitfFormatException {
        ...
        DateTimeImpl dt = new DateTimeImpl();
        ...
        TargetIdImpl tgtid = new TargetIdImpl("ABCDEFGHIJUVWXYAU");
        ...
        ImageCoordinatePair coord00 = new ImageCoordinatePairImpl();
        ImageCoordinatePair coord0MaxCol = new ImageCoordinatePairImpl();
        ImageCoordinatePair coordMaxRowMaxCol = new ImageCoordinatePairImpl();
        ImageCoordinatePair coordMaxRow0 = new ImageCoordinatePairImpl();
        ImageCoordinates testCoordinates = new ImageCoordinatesImpl(new ImageCoordinatePair[]{coord00, coord0MaxCol, coordMaxRowMaxCol, coordMaxRow0});
        ...
        ImageBand imageBand1 = new ImageBandImpl();
        segment.addImageBand(imageBand1);
        ImageBand imageBand2 = new ImageBandImpl();
