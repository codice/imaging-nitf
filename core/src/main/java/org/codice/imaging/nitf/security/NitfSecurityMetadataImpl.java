...
*/
public class NitfSecurityMetadataImpl
        implements NitfSecurityMetadata {
    ...
    /**
        Default constructor.
    */
    public NitfSecurityMetadataImpl() {
    }
    ...
    */
    public NitfSecurityMetadataImpl(final NitfReader nitfReader) throws ParseException {
    ...
    */
    ...
    public final void setSecurityClassification(
            final NitfSecurityClassification securityClassification) {
