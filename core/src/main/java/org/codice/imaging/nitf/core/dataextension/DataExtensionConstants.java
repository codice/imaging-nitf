...
final class DataExtensionConstants {
     ...
     */
    static final String TRE_OVERFLOW = "TRE_OVERFLOW";
     ...
     * See MIL-STD-2500A.
     */
    static final String REGISTERED_EXTENSIONS = "Registered Extensions";
     ...
     * See MIL-STD-2500A.
     */
    static final String CONTROLLED_EXTENSIONS = "Controlled Extensions";
