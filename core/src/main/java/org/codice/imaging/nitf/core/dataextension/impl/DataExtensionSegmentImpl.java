...
import static org.codice.imaging.nitf.core.dataextension.impl.DataExtensionConstants.CONTROLLED_EXTENSIONS;
...
import static org.codice.imaging.nitf.core.dataextension.impl.DataExtensionConstants.REGISTERED_EXTENSIONS;
import static org.codice.imaging.nitf.core.dataextension.impl.DataExtensionConstants.STREAMING_FILE_HEADER;
...
import org.codice.imaging.nitf.core.common.impl.CommonSegmentImpl;
...
class DataExtensionSegmentImpl extends CommonSegmentImpl implements DataExtensionSegment {
    ...
    */
    ...
    public final boolean isTreOverflowNitf21() {
        return getIdentifier().trim().equals(DataExtensionConstants.TRE_OVERFLOW);
    }
