...
/**
    ...
    <p>
    This represents the colour format in a NITF 2.1 image segment.
    <p>
    ...
    [From MIL-STD-2500C, TABLE A-5. "NITF image subheader"]
    <p>
...
public enum GraphicColour {
    ...
    */
    ...
    /**
        Create image colour from the text equivalent.
        <p>
        This is intended to support file parsing, and is not usually necessary
        for other purposes.

        @param textEquivalent the single character text equivalent for a image colour
        @return the corresponding image colour
    */
    ...
    /**
        Return the text equivalent for a image colour.
        <p>
        This is intended for debug output and output writing, and is not usually
        necessary for other purposes.

        @return the single character text equivalent for a image colour.
    */
