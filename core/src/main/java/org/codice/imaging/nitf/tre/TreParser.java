    ...
    */
    ...
    Tre parseOneTre(final NitfReader reader, final String tag, final int fieldLength) throws ParseException {
        ...
        if (treType == null) {
            ...
            TreGroupImpl group = parseTreComponents(treType.getFieldOrLoopOrIf(), reader, parameters);
            tre.setEntries(group.getEntries());
        }
        return tre;
    }

    private TreGroupImpl parseTreComponents(final List<Object> fieldOrLoopOrIf, final NitfReader reader, final TreParams params)
    ...
    private TreEntryImpl parseField(final FieldType field, final NitfReader reader, final TreParams parameters) throws ParseException {
        ...
        if (fieldKey == null) {
            ...
            if (fieldKey.isEmpty()) {
                return new TreEntryImpl("no name", fieldValue);
            } else {
                parameters.addParameter(fieldKey, fieldValue);
                return new TreEntryImpl(fieldKey, fieldValue);
            }
        }
    }
    ...
    private TreEntryImpl parseLoop(final LoopType loopType, final NitfReader reader, final TreParams params) throws ParseException {
