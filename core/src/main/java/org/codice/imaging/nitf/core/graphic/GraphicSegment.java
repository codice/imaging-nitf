...
public interface GraphicSegment extends CommonBasicSegment {
     ...
     * <p>
     * From MIL-STD-2500C: "This field shall contain a valid value that
     * indicates the graphic display level of the graphic relative to other
     * displayed file components in a composite display. The valid values are
     * 001 to 999. The display level of each displayable file component (image
     * or graphic) within a file shall be unique; that is, each number from 001
     * to 999 is the display level of, at most, one item. The meaning of display
     * level is discussed in paragraph 5.3.3. The graphic or image component in
     * the file having the minimum display level shall have attachment level 0
     * (ALVL000) (BCS zeros (0x30))."
     * <p>
     ...
     * <p>
     * From MIL-STD-2500C: "The graphics location is specified by providing the
     * location of the graphic’s origin point relative to the position (location
     * of the CCS, image, or graphic to which it is attached. This field shall
     * contain the graphic location offset from the ILOC or SLOC value of the
     * CCS, image, or graphic to which the graphic is attached or from the
     * origin of the CCS when the graphic is unattached (SALVL000). A row and
     * column value of 000 indicates no offset. Positive row and column values
     * indicate offsets down and to the right, while negative row and column
     * values indicate offsets up and to the left."
     *
     ...
     * <p>
     * From MIL-STD-2500C: "This field shall contain an ordered pair of integers
     * defining a location in Cartesian coordinates for use with CGM graphics.
     * It is the upper left corner of the bounding box for the CGM graphic. See
     * paragraph 5.5.2.1 for a description. The format is rrrrrccccc, where
     * rrrrr is the row and ccccc is the column offset from ILOC or SLOC value
     * of the item to which the graphic is attached. If the graphic is
     * unattached (value of the SALVL field is equal to BCS zeros (0x30)), rrrrr
     * and ccccc represent offsets from the origin of the coordinate system that
     * is common to all images and graphics in the file having the value of BCS
     * zeros (0x30) in the SALVL field. The range for rrrrr and ccccc shall be
     * -9999 to 99999."
     *
     ...
     * From MIL-STD-2500C: "This field shall contain an ordered pair of integers
     * defining a location in Cartesian coordinates for use with CGM graphics.
     * It is the lower right corner of the bounding box for the CGM graphic. See
     * paragraph 5.5.2.1 for a description. The format is rrrrrccccc, where
     * rrrrr is the row and ccccc is the column offset from ILOC or SLOC value
     * of the item to which the graphic is attached. If the graphic is
     * unattached (SALVL field value is BCS zeros(0x30)), rrrrr and ccccc
     * represent offsets from the origin of the coordinate system that is common
     * to all images and graphics in the file having the value of BCS zeros
     * (0x30) in the SALVL field. The range for rrrrr and ccccc shall be -9999
     * to 99999."
     *
     ...
     */
    void setGraphicColour(final GraphicColour colour);
     ...
     */
    void setGraphicName(final String name);
     ...
     * -9999 to 99999."
     *
     * @param columnNumber the column number for the first bounding box
     * location.
     */
    void setBoundingBox1Column(final int columnNumber);
     ...
     */
    void setBoundingBox1Row(final int rowNumber);
     ...
     * to 99999."
     *
     * @param columnNumber the column number for the second bounding box
     * location.
     */
    void setBoundingBox2Column(final int columnNumber);
     ...
     */
    void setBoundingBox2Row(final int rowNumber);
     ...
     */
    void setGraphicDisplayLevel(final int displayLevel);
     ...
     */
    void setGraphicLocationColumn(final int columnNumber);
     ...
     */
    void setGraphicLocationRow(final int rowNumber);
