...
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LAT_DEGREES_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LAT_HEMISPHERE_MARKER_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LAT_MINUTES_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LAT_SECONDS_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LON_DEGREES_LENGTH;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LON_DEGREES_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LON_HEMISPHERE_MARKER_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LON_MINUTES_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.LON_SECONDS_OFFSET;
import static org.codice.imaging.nitf.core.image.impl.CoordinateConstants.MINUTES_IN_ONE_DEGREE;
...
*/
public class ImageCoordinatePairImpl implements ImageCoordinatePair {
    ...
    /**
        Default constructor.
    */
    public ImageCoordinatePairImpl() {
    }
    ...
    */
    public ImageCoordinatePairImpl(final double latitude, final double longitude) {
        lat = latitude;
        lon = longitude;
    }
