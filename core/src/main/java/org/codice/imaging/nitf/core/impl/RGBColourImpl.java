...
*/
public class RGBColourImpl implements org.codice.imaging.nitf.core.RGBColour {
    ...
    */
    public RGBColourImpl(final byte[] rgb) throws NitfFormatException {
     ...
     */
    public RGBColourImpl(final byte redComponent, final byte greenComponent, final byte blueComponent) {
        red = redComponent;
