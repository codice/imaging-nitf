...
public final class LabelSegmentFactory {
    ...
    public static LabelSegment getDefault() {
        LabelSegmentImpl labelSegment = new LabelSegmentImpl();
        ...
        labelSegment.setLabelBackgroundColour(new RGBColourImpl((byte) 0, (byte) 0, (byte) 0));
        labelSegment.setLabelTextColour(new RGBColourImpl(RGBColourImpl.CODICE_LOGO_RED_COMPONENT,
