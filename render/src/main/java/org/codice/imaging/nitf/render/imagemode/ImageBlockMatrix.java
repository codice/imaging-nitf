...
class ImageBlockMatrix {
    ...
    /**
     *
     * @param header - the NitfImageSegmentHeader that this matrix is being created for.
     */
    public ImageBlockMatrix(NitfImageSegmentHeader header, Supplier<BufferedImage> imageSupplier) {
        this.matrixWidth = (int) header.getNumberOfBlocksPerColumn();
        this.matrixHeight = (int) header.getNumberOfBlocksPerRow();
        int blockWidth = header.getNumberOfPixelsPerBlockHorizontal();
        int blockHeight = header.getNumberOfPixelsPerBlockVertical();
