...
public class Jpeg2000Test {
    ...
    @Test
    public void checkJpeg2000MaskRender() throws IOException, URISyntaxException {
        ...
        Mockito.when(mockImageSegment.getImageCompression()).thenReturn(ImageCompression.JPEG2000MASK);
    ...
    @Test
    public void checkJpeg2000MaskRender2() throws IOException, URISyntaxException {
        NitfRenderer renderer = new NitfRenderer();
